...
Router::scope('/', function (RouteBuilder $routes) {
     ...
     */
	 ...
	 $routes->connect('/customer-segs', ['controller' => 'CustomerSegs', 'action' => 'add', 'home']);
	 $routes->connect('/item-categories', ['controller' => 'ItemCategories', 'action' => 'index', 'home']);
	 $routes->connect('/item-groups', ['controller' => 'ItemGroups', 'action' => 'index', 'home']);
	 $routes->connect('/item-sub-groups', ['controller' => 'ItemSubGroups', 'action' => 'index', 'home']);
