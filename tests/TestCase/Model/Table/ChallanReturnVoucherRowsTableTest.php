...
use App\Model\Table\ChallanReturnVoucherRowsTable;
use Cake\ORM\TableRegistry;
use Cake\TestSuite\TestCase;

/**
 * App\Model\Table\ChallanReturnVoucherRowsTable Test Case
 */
class ChallanReturnVoucherRowsTableTest extends TestCase
{

    /**
     * Test subject
     *
     * @var \App\Model\Table\ChallanReturnVoucherRowsTable
     */
    public $ChallanReturnVoucherRows;
    ...
    {
        parent::setUp();
        $config = TableRegistry::exists('ChallanReturnVoucherRows') ? [] : ['className' => 'App\Model\Table\ChallanReturnVoucherRowsTable'];
        $this->ChallanReturnVoucherRows = TableRegistry::get('ChallanReturnVoucherRows', $config);
    }
    ...
    {
        unset($this->ChallanReturnVoucherRows);
