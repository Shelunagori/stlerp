...
use App\Model\Table\LoanInstallmentsTable;
use Cake\ORM\TableRegistry;
use Cake\TestSuite\TestCase;

/**
 * App\Model\Table\LoanInstallmentsTable Test Case
 */
class LoanInstallmentsTableTest extends TestCase
{

    /**
     * Test subject
     *
     * @var \App\Model\Table\LoanInstallmentsTable
     */
    ...
    {
        parent::setUp();
        $config = TableRegistry::exists('LoanInstallments') ? [] : ['className' => 'App\Model\Table\LoanInstallmentsTable'];
        $this->LoanInstallments = TableRegistry::get('LoanInstallments', $config);
    }
