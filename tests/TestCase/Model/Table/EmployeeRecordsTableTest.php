...
class EmployeeRecordsTableTest extends TestCase
{
    ...
    {
        parent::setUp();
        $config = TableRegistry::exists('EmployeeRecords') ? [] : ['className' => 'App\Model\Table\EmployeeRecordsTable'];
        $this->EmployeeRecords = TableRegistry::get('EmployeeRecords', $config);
    }
