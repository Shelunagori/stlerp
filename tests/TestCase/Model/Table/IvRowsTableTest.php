...
use App\Model\Table\IvRowsTable;
use Cake\ORM\TableRegistry;
use Cake\TestSuite\TestCase;

/**
 * App\Model\Table\IvRowsTable Test Case
 */
class IvRowsTableTest extends TestCase
{

    /**
     * Test subject
     *
     * @var \App\Model\Table\IvRowsTable
     */
    public $IvRows;
    ...
    {
        parent::setUp();
        $config = TableRegistry::exists('IvRows') ? [] : ['className' => 'App\Model\Table\IvRowsTable'];
        $this->IvRows = TableRegistry::get('IvRows', $config);
    }
