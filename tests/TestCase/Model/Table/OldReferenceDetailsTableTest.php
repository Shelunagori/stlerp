...
use App\Model\Table\OldReferenceDetailsTable;
use Cake\ORM\TableRegistry;
use Cake\TestSuite\TestCase;

/**
 * App\Model\Table\OldReferenceDetailsTable Test Case
 */
class OldReferenceDetailsTableTest extends TestCase
{

    /**
     * Test subject
     *
     * @var \App\Model\Table\OldReferenceDetailsTable
     */
    public $OldReferenceDetails;
    ...
    {
        parent::setUp();
        $config = TableRegistry::exists('OldReferenceDetails') ? [] : ['className' => 'App\Model\Table\OldReferenceDetailsTable'];
        $this->OldReferenceDetails = TableRegistry::get('OldReferenceDetails', $config);
    }
    ...
    {
        unset($this->OldReferenceDetails);
