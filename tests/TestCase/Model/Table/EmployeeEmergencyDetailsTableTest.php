...
use App\Model\Table\EmployeeEmergencyDetailsTable;
use Cake\ORM\TableRegistry;
use Cake\TestSuite\TestCase;

/**
 * App\Model\Table\EmployeeEmergencyDetailsTable Test Case
 */
class EmployeeEmergencyDetailsTableTest extends TestCase
{

    /**
     * Test subject
     *
     * @var \App\Model\Table\EmployeeEmergencyDetailsTable
     */
    public $EmployeeEmergencyDetails;
    ...
    {
        parent::setUp();
        $config = TableRegistry::exists('EmployeeEmergencyDetails') ? [] : ['className' => 'App\Model\Table\EmployeeEmergencyDetailsTable'];
        $this->EmployeeEmergencyDetails = TableRegistry::get('EmployeeEmergencyDetails', $config);
    }
    ...
    {
        unset($this->EmployeeEmergencyDetails);
