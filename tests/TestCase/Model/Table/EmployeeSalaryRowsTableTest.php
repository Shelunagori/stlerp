...
use App\Model\Table\EmployeeSalaryRowsTable;
use Cake\ORM\TableRegistry;
use Cake\TestSuite\TestCase;

/**
 * App\Model\Table\EmployeeSalaryRowsTable Test Case
 */
class EmployeeSalaryRowsTableTest extends TestCase
{

    /**
     * Test subject
     *
     * @var \App\Model\Table\EmployeeSalaryRowsTable
     */
    public $EmployeeSalaryRows;
    ...
    {
        parent::setUp();
        $config = TableRegistry::exists('EmployeeSalaryRows') ? [] : ['className' => 'App\Model\Table\EmployeeSalaryRowsTable'];
        $this->EmployeeSalaryRows = TableRegistry::get('EmployeeSalaryRows', $config);
    }
