...
use App\Model\Table\ChallanReturnVouchersTable;
use Cake\ORM\TableRegistry;
use Cake\TestSuite\TestCase;

/**
 * App\Model\Table\ChallanReturnVouchersTable Test Case
 */
class ChallanReturnVouchersTableTest extends TestCase
{

    /**
     * Test subject
     *
     * @var \App\Model\Table\ChallanReturnVouchersTable
     */
    public $ChallanReturnVouchers;
    ...
    {
        parent::setUp();
        $config = TableRegistry::exists('ChallanReturnVouchers') ? [] : ['className' => 'App\Model\Table\ChallanReturnVouchersTable'];
        $this->ChallanReturnVouchers = TableRegistry::get('ChallanReturnVouchers', $config);
    }
    ...
    {
        unset($this->ChallanReturnVouchers);
