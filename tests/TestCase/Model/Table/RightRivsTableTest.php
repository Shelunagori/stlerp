...
use App\Model\Table\RightRivsTable;
use Cake\ORM\TableRegistry;
use Cake\TestSuite\TestCase;

/**
 * App\Model\Table\RightRivsTable Test Case
 */
class RightRivsTableTest extends TestCase
{

    /**
     * Test subject
     *
     * @var \App\Model\Table\RightRivsTable
     */
    public $RightRivs;
    ...
    {
        parent::setUp();
        $config = TableRegistry::exists('RightRivs') ? [] : ['className' => 'App\Model\Table\RightRivsTable'];
        $this->RightRivs = TableRegistry::get('RightRivs', $config);
    }
