...
use App\Model\Table\IvRowItemsTable;
use Cake\ORM\TableRegistry;
use Cake\TestSuite\TestCase;

/**
 * App\Model\Table\IvRowItemsTable Test Case
 */
class IvRowItemsTableTest extends TestCase
{

    /**
     * Test subject
     *
     * @var \App\Model\Table\IvRowItemsTable
     */
    public $IvRowItems;
    ...
    {
        parent::setUp();
        $config = TableRegistry::exists('IvRowItems') ? [] : ['className' => 'App\Model\Table\IvRowItemsTable'];
        $this->IvRowItems = TableRegistry::get('IvRowItems', $config);
    }
