...
use App\Model\Table\IvsTable;
use Cake\ORM\TableRegistry;
use Cake\TestSuite\TestCase;

/**
 * App\Model\Table\IvsTable Test Case
 */
class IvsTableTest extends TestCase
{

    /**
     * Test subject
     *
     * @var \App\Model\Table\IvsTable
     */
    public $Ivs;
    ...
    {
        parent::setUp();
        $config = TableRegistry::exists('Ivs') ? [] : ['className' => 'App\Model\Table\IvsTable'];
        $this->Ivs = TableRegistry::get('Ivs', $config);
    }
