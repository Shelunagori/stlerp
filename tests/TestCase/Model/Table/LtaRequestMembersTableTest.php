...
use App\Model\Table\LtaRequestMembersTable;
use Cake\ORM\TableRegistry;
use Cake\TestSuite\TestCase;

/**
 * App\Model\Table\LtaRequestMembersTable Test Case
 */
class LtaRequestMembersTableTest extends TestCase
{

    /**
     * Test subject
     *
     * @var \App\Model\Table\LtaRequestMembersTable
     */
    public $LtaRequestMembers;
    ...
    {
        parent::setUp();
        $config = TableRegistry::exists('LtaRequestMembers') ? [] : ['className' => 'App\Model\Table\LtaRequestMembersTable'];
        $this->LtaRequestMembers = TableRegistry::get('LtaRequestMembers', $config);
    }
