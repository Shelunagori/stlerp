...
use App\Model\Table\OpeningBalancesTable;
use Cake\ORM\TableRegistry;
use Cake\TestSuite\TestCase;

/**
 * App\Model\Table\OpeningBalancesTable Test Case
 */
class OpeningBalancesTableTest extends TestCase
{

    /**
     * Test subject
     *
     * @var \App\Model\Table\OpeningBalancesTable
     */
    ...
    {
        parent::setUp();
        $config = TableRegistry::exists('OpeningBalances') ? [] : ['className' => 'App\Model\Table\OpeningBalancesTable'];
        $this->OpeningBalances = TableRegistry::get('OpeningBalances', $config);
    }
