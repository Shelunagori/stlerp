...
use App\Model\Table\EmployeeFamilyMembersTable;
use Cake\ORM\TableRegistry;
use Cake\TestSuite\TestCase;

/**
 * App\Model\Table\EmployeeFamilyMembersTable Test Case
 */
class EmployeeFamilyMembersTableTest extends TestCase
{

    /**
     * Test subject
     *
     * @var \App\Model\Table\EmployeeFamilyMembersTable
     */
    ...
    {
        parent::setUp();
        $config = TableRegistry::exists('EmployeeFamilyMembers') ? [] : ['className' => 'App\Model\Table\EmployeeFamilyMembersTable'];
        $this->EmployeeFamilyMembers = TableRegistry::get('EmployeeFamilyMembers', $config);
    }
    ...
    {
        unset($this->EmployeeFamilyMembers);
