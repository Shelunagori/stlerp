...
use App\Model\Table\LtaRequestsTable;
use Cake\ORM\TableRegistry;
use Cake\TestSuite\TestCase;

/**
 * App\Model\Table\LtaRequestsTable Test Case
 */
class LtaRequestsTableTest extends TestCase
{

    /**
     * Test subject
     *
     * @var \App\Model\Table\LtaRequestsTable
     */
    public $LtaRequests;
    ...
    {
        parent::setUp();
        $config = TableRegistry::exists('LtaRequests') ? [] : ['className' => 'App\Model\Table\LtaRequestsTable'];
        $this->LtaRequests = TableRegistry::get('LtaRequests', $config);
    }
