...
use App\Model\Table\CompanyWiseEmployeeSalariesTable;
use Cake\ORM\TableRegistry;
use Cake\TestSuite\TestCase;

/**
 * App\Model\Table\CompanyWiseEmployeeSalariesTable Test Case
 */
class CompanyWiseEmployeeSalariesTableTest extends TestCase
{

    /**
     * Test subject
     *
     * @var \App\Model\Table\CompanyWiseEmployeeSalariesTable
     */
    public $CompanyWiseEmployeeSalaries;
     ...
     */
    public $fixtures = [
        'app.company_wise_employee_salaries',
        'app.employees',
        'app.ledger_accounts',
    ...
    {
        parent::setUp();
        $config = TableRegistry::exists('CompanyWiseEmployeeSalaries') ? [] : ['className' => 'App\Model\Table\CompanyWiseEmployeeSalariesTable'];
        $this->CompanyWiseEmployeeSalaries = TableRegistry::get('CompanyWiseEmployeeSalaries', $config);
    }
    ...
    {
        unset($this->CompanyWiseEmployeeSalaries);
