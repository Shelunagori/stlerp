...
use App\Model\Table\RivsTable;
use Cake\ORM\TableRegistry;
use Cake\TestSuite\TestCase;

/**
 * App\Model\Table\RivsTable Test Case
 */
class RivsTableTest extends TestCase
{

    /**
     * Test subject
     *
     * @var \App\Model\Table\RivsTable
     */
    public $Rivs;
    ...
    {
        parent::setUp();
        $config = TableRegistry::exists('Rivs') ? [] : ['className' => 'App\Model\Table\RivsTable'];
        $this->Rivs = TableRegistry::get('Rivs', $config);
    }
