...
use App\Model\Table\EmployeeReferenceDetailsTable;
use Cake\ORM\TableRegistry;
use Cake\TestSuite\TestCase;

/**
 * App\Model\Table\EmployeeReferenceDetailsTable Test Case
 */
class EmployeeReferenceDetailsTableTest extends TestCase
{

    /**
     * Test subject
     *
     * @var \App\Model\Table\EmployeeReferenceDetailsTable
     */
    public $EmployeeReferenceDetails;
    ...
    {
        parent::setUp();
        $config = TableRegistry::exists('EmployeeReferenceDetails') ? [] : ['className' => 'App\Model\Table\EmployeeReferenceDetailsTable'];
        $this->EmployeeReferenceDetails = TableRegistry::get('EmployeeReferenceDetails', $config);
    }
    ...
    {
        unset($this->EmployeeReferenceDetails);
