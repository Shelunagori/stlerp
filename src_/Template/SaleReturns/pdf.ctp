					...
					<table  valign="center" width="100%" style="margin-top: 0px;" class="table2">
						<tr>
							...
							<td width="50%" valign="top" align="right" >
								<table width="100%">
									<tr>
										<td style="font-size:'. h(($invoice->pdf_font_size)) .';" width="25%" valign="top" style="vertical-align: top;">Voucher No.</td>
										<td style="font-size:'. h(($invoice->pdf_font_size)) .';" width="5%" valign="top">:</td>
										<td style="font-size:'. h(($invoice->pdf_font_size)) .';" valign="top">'. h(($invoice->sr1." / CR-".str_pad($invoice->sr2, 3, "0", STR_PAD_LEFT)." / ".$invoice->sr3." / ".$invoice->sr4)) .'</td>
									</tr>
									<tr>
										...
										<td style="font-size:'. h(($invoice->pdf_font_size)) .';" valign="top">'. h(date("d-m-Y",strtotime($invoice->transaction_date))) .'</td>
									</tr>
									<tr>
...
$sr=0; foreach ($invoice->sale_return_rows as $sale_return_row): $sr++; 
$html.='
	<tr class="odd">
		...
		<td style="font-size:'. h(($invoice->pdf_font_size)) .';" style="padding-top:8px;padding-bottom:5px;" valign="top" width="100%">'.$sale_return_row->item->name .'<div style="height:'.$sale_return_row->height.'"></div></td>
		<td style="font-size:'. h(($invoice->pdf_font_size)) .';" style="padding-top:8px;padding-bottom:5px;" valign="top" align="center">'. h($sale_return_row->item->unit->name) .'</td>
		<td style="font-size:'. h(($invoice->pdf_font_size)) .';" style="padding-top:8px;padding-bottom:5px;" valign="top" align="center">'. h($sale_return_row->quantity) .'</td>
		<td style="font-size:'. h(($invoice->pdf_font_size)) .';" style="padding-top:8px;padding-bottom:5px;" align="right" valign="top">'. $this->Number->format($sale_return_row->rate,[ 'places' => 2]) .'</td>
		<td style="font-size:'. h(($invoice->pdf_font_size)) .';" style="padding-top:8px;padding-bottom:5px;" align="right" valign="top">'. $this->Number->format($sale_return_row->amount,[ 'places' => 2]) .'</td>
	</tr>';
