...
$pdf_url=$this->Url->build(['controller'=>'PurchaseOrders','action'=>'pdfForMail']);
?>
<table width="100%">
	<tr>
		...
		<td width="80%">
			<object data="<?php echo $pdf_url.'/'.base64_encode($id); ?>" type="application/pdf" width="100%" height="613px">
