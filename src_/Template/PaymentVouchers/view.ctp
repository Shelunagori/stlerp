...
<table width="100%" class="divHeader">
		<tr>
			<td width="30%"><?php echo $this->Html->image('/logos/'.$paymentVoucher->company->logo, ['width' => '40%']); ?></td>
			<td align="center" width="40%" style="font-size: 12px;"><div align="center" style="font-size: 16px;font-weight: bold;color: #0685a8;">PAYMENT VOUCHER</div></td>
			<td align="right" width="30%" style="font-size: 12px;">
			<span style="font-size: 14px;"><?= h($paymentVoucher->company->name) ?></span>
			<span><?= $this->Text->autoParagraph(h($paymentVoucher->company->address)) ?>
			<?= h($paymentVoucher->company->mobile_no) ?></span>
			</td>
		</tr>
		<tr>
			<td colspan="3">
