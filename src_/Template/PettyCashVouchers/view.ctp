            ...
            <td width="50%" valign="top" align="left">
                <table>
                    ...
                    <tr>
						...
						<?php 
							$s_year_from = date("Y",strtotime($pettycashvoucher->financial_year->date_from));
							$s_year_to = date("Y",strtotime($pettycashvoucher->financial_year->date_to));
...
<td align="right">
				<table>
					<tr>
						<td align="center">
						<span style="font-size:14px;font-weight: bold;">For</span> <span style="font-size: 14px;font-weight: bold;"><?= h($pettycashvoucher->company->name)?><br/></span>
						<?php 
						 echo $this->Html->Image('/signatures/'.$pettycashvoucher->creator->signature,['height'=>'50px','style'=>'height:50px;']); 
						 ?></br>
						<span style="font-size: 14px;font-weight: bold;">Prepared By</span>
						</br>
						<span style="font-size:14px;"><?= h($pettycashvoucher->creator->name) ?></span><br/>
						</td>
					</tr>
				</table>
			</td>
