	...
	<tbody>
		<?php  $i=1; foreach($inventoryTransferVoucher->inventory_transfer_voucher_rows as $out_item){ ?>
			<tr>
				...
				<td align="center" valign="top" width="30%"><?php echo $out_item->narration; ?></td>
			</tr>
		<?php $i++; } ?>
...
<table width="96%">
	<tr>
		...
		<table >
			<tr>
			    <td align="center">
				<span style="font-size:14px;font-weight: bold;">For</span> <span style="font-size: 14px;font-weight: bold;"><?= h($inventoryTransferVoucher->company->name)?><br/></span>
				<?php 
