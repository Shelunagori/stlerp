					...
					<tbody>
						...
						<tr>
							...
							<td class="actions">
								...
								if(!empty($leaveApplication->supporting_attached)){
									echo $this->Html->link('<i class="fa fa-eye"></i>',$leaveApplication->supporting_attached,array('escape'=>false,'target'=>'_blank','class'=>'btn btn-xs blue tooltips','data-original-title'=>'View Attachment'));
								}
