		...
		<?php echo $this->Form->create($ltaRequest, ['id'=>'form_sample_3','enctype'=>'multipart/form-data', 'class'=>'form-horizontal']); ?>
			<div class="form-body">
				...
				<div class="form-group">
					...
					<div class="col-md-4">
						<?php echo $this->Form->input('data_of_submission', ['type'=>'text','label' => false,'class'=>'form-control input-sm date-picker','data-date-format'=>'dd-mm-yyyy','placeholder'=>'dd-mm-yyyy']); ?>
					</div>
				</div>
				<div class="form-group">
					<label class="col-md-3 control-label">Date of leave required from</label>
					<div class="col-md-4">
						<?php echo $this->Form->input('date_of_leave_required_from', ['type'=>'text','label' => false,'class'=>'form-control input-sm date-picker','data-date-format'=>'dd-mm-yyyy','placeholder'=>'dd-mm-yyyy']); ?>
					</div>
				</div>
				<div class="form-group">
					<label class="col-md-3 control-label">Date of leave required to</label>
					<div class="col-md-4">
						<?php echo $this->Form->input('date_of_leave_required_to', ['type'=>'text','label' => false,'class'=>'form-control input-sm date-picker','data-date-format'=>'dd-mm-yyyy','placeholder'=>'dd-mm-yyyy']); ?>
					</div>
				</div>
				<div class="form-group">
					<label class="col-md-3 control-label">Proposed date of onward journey</label>
					<div class="col-md-4">
						<?php echo $this->Form->input('proposed_date_of_onward_journey', ['type'=>'text','label' => false,'class'=>'form-control input-sm date-picker','data-date-format'=>'dd-mm-yyyy','placeholder'=>'dd-mm-yyyy']); ?>
					</div>
				</div>
				<div class="form-group">
					<label class="col-md-3 control-label">Probable date of return journey</label>
					<div class="col-md-4">
						<?php echo $this->Form->input('probable_date_of_return_journey', ['type'=>'text','label' => false,'class'=>'form-control input-sm date-picker','data-date-format'=>'dd-mm-yyyy','placeholder'=>'dd-mm-yyyy']); ?>
					</div>
				</div>
				<div class="form-group">
