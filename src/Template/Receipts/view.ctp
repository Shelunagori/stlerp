...
<div style="border:solid 1px #c7c7c7;background-color: #FFF;padding: 10px;margin: auto;width: 55%;font-size: 12px;" class="maindiv">	
	...
	<table width="100%" class="table" style="font-size:12px">
		...
		<td colspan="3" style="border-top:none !important;">
			...
			<?php $dr_amt=0; $cr_amt=0; foreach($receiptRows->reference_details as $refbal): ?>
			<tr>
		...
		<tr>
		   ...
		   <td align="right">
				<table>
					<tr>
						<td align="center">
						<span style="font-size:14px;font-weight: bold;">For</span> <span style="font-size: 14px;font-weight: bold;"><?= h($receipt->company->name)?><br/></span>
						<?php 
						 echo $this->Html->Image('/signatures/'.$receipt->creator->signature,['height'=>'50px','style'=>'height:50px;']); 
						 ?></br>
						<span style="font-size: 14px;font-weight: bold;">Prepared By</span>
						</br>
						<span style="font-size:14px;"><?= h($receipt->creator->name) ?></span><br/>
						</td>
					</tr>
				</table>
			</td>
