				...
				<div class="row">
					...
					<div class="col-md-3">
						<div class="form-group">
							...
							$option =[];
							foreach($ledger_account_details as  $ledger_account_detail)
							{ 
				...
				<tbody>
					...
					$q=0; foreach ($grn->grn_rows as $grn_rows):?>
						<tr class="tr1" row_no='<?php echo @$grn_rows->id; ?>'>
							...
							<td><?php echo $this->Form->input('invoice_booking_rows.'.$q.'.unit_rate_from_po',['value'=>$item_po_info[$grn_rows->purchase_order_row_id]->rate,'type'=>'text','label'=>false,'class'=>'form-control input-sm row_textbox cal','readonly']); ?></td>
							...
							<td align="center">
							<?php echo $this->Form->input('invoice_booking_rows.'.$q.'.gst_discount_per',['value'=>0,'type'=>'text','label'=>false,'class'=>'form-control input-sm row_textbox  disc_amt']); ?>
							</td>
							
							<td align="center">
							<?php echo $this->Form->input('invoice_booking_rows.'.$q.'.discount',['value'=>0,'type'=>'text','label'=>false,'class'=>'form-control input-sm row_textbox dis_per']); ?>
							</td>
							
							<td align="center">
							<?php echo $this->Form->input('invoice_booking_rows.'.$q.'.gst_pnf_per',['label' => false,'class' => 'form-control input-sm required row_textbox disc_amt','id'=>'update_pnf','type'=>'text','placeholder' => 'pnf','value'=>0]); ?>
							</td>
