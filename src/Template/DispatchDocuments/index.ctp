<div class="portlet light bordered">
	<div class="portlet-title">
		<div class="caption">
			...
			<span class="caption-subject font-blue-steel uppercase">Dispatch Document</span>
		</div>
	</div>
	<div class="portlet-body form">
		...
		<div class="row ">
		<div class="col-md-6">
		 <?= $this->Form->create($dispatchDocument,array("class"=>"form-horizontal",'id'=>'form_sample_3')) ?>
			<div class="form-body">
				<div class="form-group">
					<label class="control-label col-md-3">Text  <span class="required" aria-required="true">
					* </span>
					</label>
					<div class="col-md-9">
		...
		<div class="col-md-6">
			...
			<table class="table table-hover">
				...
				<tbody>
					 <?php $i=0; foreach ($dispatchDocuments as $designation): $i++; ?>
					<tr>
						<td><?= h($i) ?></td>
						<td><?= h($designation->text_line) ?></td>
						<td class="actions">
