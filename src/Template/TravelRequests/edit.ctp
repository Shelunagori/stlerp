			      ...
			      <div class="col-md-5">
						<div class="form-group">
							...
							<?php if($empData->department->name=='HR & Administration' || $empData->designation->name=='Director'){ ?>
								<?php echo $this->Form->input('employee_id', ['empty'=>'--Select--','options' =>@$employees,'label' => false,'class' => 'form-control input-sm select2me empDropDown','value'=>$travelRequest->employee_id]); ?>
				...
				<div class="col-md-10" style="padding-bottom:10px;">
					...
					<div class="col-md-3">
						<div class="form-group">
							...
							<?php echo $this->Form->input('applied_advance_amt', ['label' => false,'placeholder'=>'','class'=>'form-control input-sm','type'=>'text']); ?>
						</div>
					</div>
					<div class="col-md-3">
						<div class="form-group">
