			...
			<div class="row">
				<div class="col-md-4">
						<div class="form-group">
							...
							<?php
							if($employeePersonalInformation->date_of_birth!='1/1/70')
							{   
								$birthDate = date("d-m-Y",strtotime($employeePersonalInformation->date_of_birth));
							}
							else{$birthDate='';}
							echo $this->Form->input('date_of_birth', ['label' => false,'placeholder'=>'Date of Joining','class'=>'form-control input-sm date-picker','data-date-format'=>'dd-mm-yyyy', 'type'=>'text','placeholder'=>'dd-mm-yyyy','value'=>@$birthDate]); ?>
						</div>
				</div>
				<div class="col-md-4">
					<div class="form-group">
					...
					<div class="col-md-4">
						<div class="form-group">
							...
							<div id="home_district1">
								<?php echo $this->Form->input('home_district', ['empty'=> '---Select District---','label' => false,'class'=>'form-control select2me input-sm','options'=>@$districts]); ?>
							</div>
						</div>
					</div>
				   ...
				   <div class="col-md-4">
						<div class="form-group">
							...
							<div id="present_district2">
								<?php echo $this->Form->input('present_district', ['empty'=> '---Select District---','label' => false,'class'=>'form-control select2me input-sm','options'=>@$districts]); ?>
							</div>
						</div>
					</div>
			       <div class="col-md-4">
			      ...
			      <div class="col-md-4">
				   ...
				   <div class="col-md-4">
						<div class="form-group">
							...
							<?php echo $this->Form->input('permanent_district', ['empty'=> '---Select District---','label' => false,'class'=>'form-control select2me input-sm','options'=>@$districts]); ?>
							</div>
						</div>
					</div>
			       <div class="col-md-4">
		...
		<fieldset style="margin-left: 0px;margin-right: 0px;">
			...
			<table id="main_table" class="table table-condensed table-bordered" style="margin-bottom: 4px;" width="100%">
				...
				<tbody id='main_tbody' class="tab">
					<?php 
					if(!empty($employeePersonalInformation->employee_personal_information_rows))
					{
						foreach($employeePersonalInformation->employee_personal_information_rows as $employee_personal_information_row)
						{
							if($employee_personal_information_row->detail_type=='employee family information')
							{
					?>
							<tr class="main_tr" class="tab">
								<td style="width:3%;"></td>
								<td style="vertical-align: top !important;width:18%;" >
									<?php echo $this->Form->input('name', ['label' => false,'class' => 'form-control input-sm first','value'=>$employee_personal_information_row->name]); ?>
									<input type="hidden" name="detail_type" value="employee family information" class="hidden">
									<?php echo $this->Form->input('id', ['value'=>$employee_personal_information_row->id,'type'=>'hidden','class'=>'idHidden']); ?>
								</td>
								<td width="14%" style="vertical-align: top !important;">
									<?php echo $this->Form->input('relation', ['label' => false,'class' => 'form-control input-sm count_value','value'=>$employee_personal_information_row->relation]); ?>
								</td>
								<td width="14%" style="vertical-align: top !important;">
									<?php
									if($employee_personal_information_row->dob!='1/1/70')
									{   
										$Dob = date("d-m-Y",strtotime($employee_personal_information_row->dob));
									}
									else{$Dob='';}
									echo $this->Form->input('dob', ['label' => false,'class' => 'form-control input-sm date-picker','data-date-format'=>'dd-mm-yyyy','placeholder'=>'dd/mm/yyyy','value'=>@$Dob]); ?>
								</td>
								<td width="10%" style="vertical-align: top !important;">
									<?php echo $this->Form->input('dependent', ['label' => false,'class' => 'form-control input-sm','value'=>$employee_personal_information_row->dependent]); ?>	
								</td>
								<td style="width:15%;vertical-align: top !important;">
									<?php echo $this->Form->input('whether_employed', ['empty'=> '---Select---','label' => false,'class'=>'form-control input-sm','options'=>@$whether_employeds,'value'=>$employee_personal_information_row->whether_employed]); ?>
								</td>							  
								<td style="width:5%;">
			...
			<table id="main_table2" class="table table-condensed table-bordered" style="margin-bottom: 4px;" width="100%">
				...
				<?php 
					if(!empty($employeePersonalInformation->employee_personal_information_rows))
					{
						foreach($employeePersonalInformation->employee_personal_information_rows as $employee_personal_information_row)
						{
							if($employee_personal_information_row->detail_type=='employee emergency details')
							{
					?>
					<tr class="main_tr" class="tab">
						...
						<td width="15%" style="vertical-align: top !important;">
							<?php echo $this->Form->input('mobile_no', ['label' => false,'class' => 'form-control input-sm','maxlength'=>10,'minlength'=>10,'value'=>$employee_personal_information_row->mobile_no]); ?>
						</td>
						<td width="15%" style="vertical-align: top !important;">
							<?php echo $this->Form->input('phone_no', ['label' => false,'class' => 'form-control input-sm','value'=>$employee_personal_information_row->phone_no]); ?>	
						</td>
						<td style="width:20%;" style="vertical-align: top !important;">
							<?php 
							echo $this->Form->input('address', ['label' => false,'class'=>'form-control input-sm','type'=>'textarea','rows'=>2,'value'=>$employee_personal_information_row->address]); ?>
						</td>							  
			...
			<table id="main_table3" class="table table-condensed table-bordered" style="margin-bottom: 4px;" width="100%">
				...
				<?php 
					if(!empty($employeePersonalInformation->employee_personal_information_rows))
					{
						foreach($employeePersonalInformation->employee_personal_information_rows as $employee_personal_information_row)
						{
							if($employee_personal_information_row->detail_type=='employee reference details')
							{
					?>
					<tr class="main_tr" class="tab">
						<td style="width:3%;vertical-align: top !important;"></td>
						<td style="vertical-align: top !important;width:17%;">
							<?php echo $this->Form->input('name', ['label' => false,'class' => 'form-control input-sm first','id'=>'check','value'=>$employee_personal_information_row->name]); ?>
			...
			<table id="main_table4" class="table table-condensed table-bordered" style="margin-bottom: 4px;" width="100%">
				...
				<?php 
					if(!empty($employeePersonalInformation->employee_personal_information_rows))
					{
						foreach($employeePersonalInformation->employee_personal_information_rows as $employee_personal_information_row)
						{
							if($employee_personal_information_row->detail_type=='employee work experience')
							{
					?>
					<tr class="main_tr" class="tab">
						<td style="width:3%;vertical-align: top !important;"></td>
						<td style="vertical-align: top !important;width:18%;">
							<?php echo $this->Form->input('period', ['label' => false,'class' => 'form-control input-sm first','id'=>'check','value'=>$employee_personal_information_row->period]); ?>
							<input type="hidden" name="detail_type" value="employee work experience" class="hidden">
							<?php echo $this->Form->input('id', ['value'=>$employee_personal_information_row->id,'type'=>'hidden','class'=>'idHidden']); ?>
						</td>
						<td width="15%" style="vertical-align: top !important;">
							<?php echo $this->Form->input('company_name', ['label' => false,'class' => 'form-control input-sm','value'=>$employee_personal_information_row->company_name]); ?>
						</td>
						<td width="15%" style="vertical-align: top !important;">
							<?php echo $this->Form->input('designation', ['label' => false,'class' => 'form-control input-sm','value'=>$employee_personal_information_row->designation]); ?>	
						</td>
						<td style="width:20%;" style="vertical-align: top !important;">
							<?php 
							echo $this->Form->input('duties_nature', ['label' => false,'class'=>'form-control input-sm','type'=>'text','value'=>$employee_personal_information_row->duties_nature]); ?>
						</td>							  
						<td style="width:5%;" style="vertical-align: top !important;">
				   ...
				   <div class="col-md-4">
						<div class="form-group">
							...
							<div id="nominee_district4">
								<?php echo $this->Form->input('nominee_district', ['empty'=> '---Select District---','label' => false,'class'=>'form-control select2me input-sm','options'=>@$districts]); ?>
							</div>
						</div>
					</div>
			       <div class="col-md-4">
			...
			<div class="col-md-12 pad">
			      ...
			      <div class="col-md-4">
						<div class="form-group">
							...
							<?php 
							if($employeePersonalInformation->appointment_date!='1/1/70')
							{   
								$appointmentDate = date("d-m-Y",strtotime($employeePersonalInformation->appointment_date));
							}
							else{$appointmentDate='';}
							echo $this->Form->input('appointment_date', ['label' => false,'placeholder'=>'dd-mm-yyyy','class'=>'form-control input-sm date-picker','data-date-format'=>'dd-mm-yyyy', 'type'=>'text','value'=>@$appointmentDate]); ?>
						</div>
					</div>
			       ...
			       <div class="col-md-4">
						<div class="form-group">
							...
							<?php 
							if($employeePersonalInformation->dept_joining_date!='1/1/70')
							{   
								$deptJoiningDate = date("d-m-Y",strtotime($employeePersonalInformation->dept_joining_date));
							}
							else{$deptJoiningDate='';}
							echo $this->Form->input('dept_joining_date', ['label' => false,'placeholder'=>'dd-mm-yyyy','class'=>'form-control input-sm date-picker','data-date-format'=>'dd-mm-yyyy', 'type'=>'text','value'=>@$deptJoiningDate]); ?>
						</div>
					</div>
			</div>
			<div class="col-md-12 pad">
			...
			<div class="col-md-12 pad">
				   ...
				   <div class="col-md-4">
						<div class="form-group">
							...
							<?php 
							if($employeePersonalInformation->retirement_date!='1/1/70')
							{   
								$retirementDate = date("d-m-Y",strtotime($employeePersonalInformation->retirement_date));
							}
							else{$retirementDate='';}if($employeePersonalInformation->retirement_date!='1/1/70')
							{   
								$retirementDate = date("d-m-Y",strtotime($employeePersonalInformation->retirement_date));
							}
							else{$retirementDate='';}
							echo $this->Form->input('retirement_date', ['label' => false,'class'=>'form-control date-picker input-sm','data-date-format'=>'dd-mm-yyyy','placeholder'=>'dd-mm-yyyy','type'=>'text','value'=>@$retirementDate]); ?>
						</div>
					</div>
			        <div class="col-md-4">
						<div class="form-group">
...
$(document).ready(function() 
{
	...
	function rename_rows(){ 
				...
				$("#main_table tbody#main_tbody tr.main_tr").each(function(){ 
					...
					$(this).find("td:nth-child(2) input.idHidden").attr({name:"employee_personal_information_rows["+i+"][id]", id:"employee_personal_information_rows-"+i+"-id"});
	...
	function rename_rows2(){ 
				...
				$("#main_table2 tbody#main_tbody2 tr.main_tr").each(function(){ 
					...
					$(this).find("td:nth-child(2) input.idHidden").attr({name:"employee_personal_information_rows["+j+"][id]", id:"employee_personal_information_rows-"+j+"-id"});
	...
	function rename_rows3(){ 
				...
				$("#main_table3 tbody#main_tbody3 tr.main_tr").each(function(){ 
					...
					$(this).find("td:nth-child(2) input.idHidden").attr({name:"employee_personal_information_rows["+k+"][id]", id:"employee_personal_information_rows-"+k+"-id"});
	...
	function rename_rows4(){ 
				...
				$("#main_table4 tbody#main_tbody4 tr.main_tr").each(function(){ 
					...
					$(this).find("td:nth-child(2) input.idHidden").attr({name:"employee_personal_information_rows["+l+"][id]", id:"employee_personal_information_rows-"+l+"-id"});
					...
					$(this).find("td:nth-child(5) input").attr({name:"employee_personal_information_rows["+l+"][duties_nature]", id:"employee_personal_information_rows-"+l+"-duties_nature"});
...
<table id="sample_table" style="display:none;" width="100%">
	<tbody>
		<tr class="main_tr" class="tab">
			...
			<td style="width:15%;vertical-align: top !important;">
				<?php echo $this->Form->input('whether_employed', ['empty'=> '---Select---','label' => false,'class'=>'form-control input-sm','options'=>@$whether_employeds]); ?>
			</td>							  
			<td style="width:5%;">
				<button type="button" class="add btn btn-default btn-xs"><i class="fa fa-plus"></i> </button>
				<a class="btn btn-danger delete-tr btn-xs" href="#" role="button" ><i class="fa fa-times"></i></a>
