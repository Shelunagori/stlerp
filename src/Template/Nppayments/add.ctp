...
<div class="portlet light bordered">
    <div class="portlet-title">
        <div class="caption" >
            ...
            <span class="caption-subject font-blue-steel uppercase">Add NonPrint Payment Voucher</span>
        </div>
    </div>
...
$(document).ready(function() {
	...
	function rename_rows(){
		...
		$("#main_table tbody#main_tbody tr.main_tr").each(function(){
			...
			$(this).find("td:nth-child(4) textarea").attr({name:"nppayment_rows["+i+"][narration]", id:"nppayment_rows-"+i+"-narration"}).rules("add", "required");
			i++;
		});
	}
	...
	function rename_ref_rows(sel,received_from_id){
		...
		$(sel).find("table.ref_table tfoot tr:nth-child(1) td:nth-child(3) input").attr({name:"nppayment_rows["+row_id+"][on_acc]", id:"ref_rows-"+row_id+"-"+i+"-ref_cr_dr"}).rules("add", "required");
