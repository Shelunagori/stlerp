<nav class="large-3 medium-4 columns" id="actions-sidebar">
    <ul class="side-nav">
        ...
        <li><?= $this->Form->postLink(
                __('Delete'),
                ['action' => 'delete', $employeePersonalInformationRow->id],
                ['confirm' => __('Are you sure you want to delete # {0}?', $employeePersonalInformationRow->id)]
            )
        ?></li>
...
<div class="employeePersonalInformationRows form large-9 medium-8 columns content">
    ...
    <fieldset>
        <legend><?= __('Edit Employee Personal Information Row') ?></legend>
        <?php
