            ...
            <td align="left" valign="top">
                <table>
                    <tr>
                        ...
                        Rs: <?= h($this->Number->format(abs($total),[ 'places' => 2])) ?></td>
                    </tr>
                    <tr>
                        <td style="font-size: 12px;">Rupees<?php echo ucwords($this->NumberWords->convert_number_to_words(abs($total))) ?> Only </td>
                    </tr>
                    <tr>
