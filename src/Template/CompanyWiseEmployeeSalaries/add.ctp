<div class="portlet light bordered">
	...
	<div class="portlet-body form">
		...
		<div class="row ">
		<div class="col-md-6">
		 <?= $this->Form->create($companyWiseEmployeeSalary,array("class"=>"form-horizontal","id"=>"form_sample_3")) ?>
			<div class="form-body">
					...
					* </span>
					...
					<div class="col-md-9">
						<div class="input-icon right">
							<i class="fa"></i>
							 <?php 
								echo $this->Form->input('ledger_account_id', ['empty'=>'--Select Ledger--','options'=>$companies,'label' => false,'class' => 'form-control input-sm  select2me','style'=>'vertical-align: top !important;']); ?>
						</div>
					</div>
				</div>
				<div class="form-group">
					<label class="control-label col-md-3">Effective Date From  <span class="required" aria-required="true">
					* </span>
					</label>
					<div class="col-md-9">
						<div class="input-icon right">
							<i class="fa"></i>
							 <?php echo $this->Form->input('from', ['type'=>'text','label' => false,'class' => 'form-control input-sm date-picker','data-date-format'=>'dd-mm-yyyy','value'=>date('d-m-Y',strtotime($EmployeeSalaryDetails->effective_date_from))]); ?>
						</div>
					</div>
				</div>
				<div class="form-group">
					<label class="control-label col-md-3">Effective Date To  <span class="required" aria-required="true">
					* </span>
					</label>
					<div class="col-md-9">
						<div class="input-icon right">
							<i class="fa"></i>
							 <?php echo $this->Form->input('to', ['type'=>'text','label' => false,'class' => 'form-control input-sm date-picker','data-date-format'=>'dd-mm-yyyy','value'=>date('d-m-Y',strtotime($EmployeeSalaryDetails->effective_date_from))]); ?>
						</div>
					</div>
				</div>
				<div class="row">
